...
export declare const getSystemConfig: (req: Request, res: Response) => Promise<void>;
export declare const updateSystemConfig: (req: Request, res: Response) => Promise<void>;
export declare const getAllJobsForAdmin: (req: Request, res: Response) => Promise<void>;
export declare const approveJob: (req: Request, res: Response) => Promise<void>;
export declare const disapproveJob: (req: Request, res: Response) => Promise<void>;
