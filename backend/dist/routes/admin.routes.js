...
router.get('/jobs', admin_controller_1.getAllJobsForAdmin);
...
router.patch('/jobs/:id/approve', admin_controller_1.approveJob);
router.patch('/jobs/:id/disapprove', admin_controller_1.disapproveJob);
router.get('/config', admin_controller_1.getSystemConfig);
router.patch('/config', admin_controller_1.updateSystemConfig);
