      ...
      <section className="flex-1 flex flex-col items-center justify-center px-6 py-20 relative overflow-hidden">
          ...
          <div className="w-full max-w-md bg-white p-12 rounded-[50px] border border-[#32312D]/10 shadow-2xl">
              <div className="text-center mb-12">
                  <div className="text-[10px] font-black text-[#3A3F5F] uppercase tracking-[0.4em] mb-4">Login</div>
                  <h1 className="text-4xl font-black tracking-tighter uppercase mb-2 text-[#32312D]">Welcome Back.</h1>
                  <p className="text-[#32312D]/40 text-[10px] font-black uppercase tracking-widest">Access your account.</p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                  <div className="space-y-2 text-left">
                      <label className="block text-[8px] font-black text-[#32312D]/40 uppercase tracking-[0.3em] ml-2">Email Address</label>
                      <input 
                        type="email" 
                        required 
                        value={email}
                  ...
                  <div className="space-y-2 text-left">
                      <label className="block text-[8px] font-black text-[#32312D]/40 uppercase tracking-[0.3em] ml-2">Password</label>
                      <input 
                        type="password" 
                        required 
                        value={password}
              ...
              <div className="mt-12 text-center">
                  <Link href="/signup" className="text-[9px] font-black text-[#32312D]/40 uppercase tracking-[0.3em] hover:text-[#3A3F5F] transition-all border-b border-[#32312D]/5 pb-1">Don't have an account? Sign up</Link>
              </div>
          </div>

          <div className="mt-12 flex gap-10">
              <Link href="/terms" className="text-[#32312D]/20 font-black uppercase text-[10px] tracking-[0.3em] hover:text-[#32312D] transition-all">Terms</Link>
              <Link href="/privacy" className="text-[#32312D]/20 font-black uppercase text-[10px] tracking-[0.3em] hover:text-[#32312D] transition-all">Privacy</Link>
          </div>
      </section>
    </div>
  );
